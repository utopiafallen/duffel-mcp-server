            ...
            for room_idx, room in enumerate(rooms, 1):
                ...
                if beds:
                    ...
                    for bed in beds:
                        ...
                        btype = (bed.get("type") or "unknown").replace("_", " ")
                ...
                if not rates:
                    ...
                    for rate_idx, rate in enumerate(rates, 1):
                        ...
                        if cancellation:
                            ...
                            cancel_detail = f" (before {_format_datetime(refund_before)})" if refund_before else ""
                            lines.append(f"- **Cancellation**: {cancel_label}{cancel_detail}")
                        else:
                        ...
                        if conditions:
                            ...
                            for cond in conditions[:5]:  # Limit to 5 conditions
                                cond_title = cond.get("title") or ""
                                cond_desc = cond.get("description") or ""
                                lines.append(f"  - **{cond_title}**: {cond_desc}")
